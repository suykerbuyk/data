...
BASE_TEST_NAME="MACH2_128K_STRIPE_SSD_512K_RA_SCH_NOOP"
MAX_WORKER_PROCESSES=8
PREP_PROCESS_WORKERS=256
LOAD_PROCESS_THREADS=48
TEST_NAME="To Be Filled in later"
TEST_DESCRIPTION="Description of test"
OBJ_SIZE=4
CONTAINER_MIN_W=1
CONTAINER_MAX_W=1500
CONTAINER_MIN_R=1501
CONTAINER_MAX_R=3000
OBJ_CNT_MIN=1
OBJ_CNT_MAX=200
CPREFIX=s3evans
ACCESS_KEY=12345
...
for OBJ_SIZE in 4 8 16 32 64 256 512 1024 2048 4096 8192
do
	for LOAD_PROCESS_THREADS in 1 2 4 8 16 24 32 40 48
	do
